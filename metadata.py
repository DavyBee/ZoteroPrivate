...
def fetch_llm(url: str, comments: list[Comment],
    ...
    prompt = (
        ...
        "path indicate one specific such work.\n"
        ...
        "Drive folder or file, a dataset portal, or a useful tool. Anything "
        "scholarly or that might point to a useful file is at least a \"link\" "
        "— never \"junk\". When unsure between \"paper\" and \"link\", choose "
        "\"link\".\n"
